...
export const generateMetadata = () => {
    return {
      ...
      canonical: "https://www.cadhirajostwal.com/services/CompanyFormation/NonProf",
    };
  };
...
const NonProf = () => {
  ...
  <Link href={"/services/CompanyFormation/CompF"}>
    <h2>Company Formation</h2>
  </Link>
  <Link href={"/services/CompanyFormation/BusReg"}>
    <h2>Business Registration</h2>
  </Link>
  <Link href={"/services/CompanyFormation/Shopact"}>
    <h2>Shop Act</h2>
  </Link>
  <Link href={"/services/CompanyFormation/MSME"}>
    <h2>MSME</h2>
  </Link>
  <Link href={"/services/CompanyFormation/LLP"}>
    <h2>Limited Liability Partnership</h2>
  </Link>
  <Link href={"/services/CompanyFormation/PartReg"}>
    <h2>Partnership Registration</h2>
  </Link>
  <Link href={"/services/CompanyFormation/CharTrust"}>
    <h2>charitable trusts</h2>
  </Link>
  <Link href={"/services/CompanyFormation/Association"}>
    <h2>Society and Associations</h2>
        ...
        <div className={styles.blog}>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            In today&aposs world, Non-Profit Organizations (NPOs) play a crucial
        ...
        <Image src="/images/istockphoto-486772894-612x612.jpg" alt="NPO Guide" className={styles.img} />
          ...
          <p>
            ...
            For those wondering "how to set up NGO," it&aposs essential to follow
          ...
          <div className={styles.unordered1}>
            <ul>
              ...
              <li>Applying for registration with the Sub-Registrar&aposs office</li>
...
<p>Limited commercial activities are allowed if they align with the NPO&aposs objectives and profits are used for the organization&aposs purposes.</p>
